...
## MinGW 설치
### PC의 운영체제 확인
![첨부파일/setting-vsc-image01.png](/setting-vsc-image01.png)
윈도우 검색에 설정을 검색하면, 다음과 같은 화면이 나온다.
홈 아래의 시스템 항목을 누른다.

![첨부파일/setting-vsc-image02.png](/setting-vsc-image02.png)
그 후 화면을 가장 아래까지 내려 정보를 누른다.

![첨부파일/setting-vsc-image03.png](/setting-vsc-image03.png)
...
![첨부파일/setting-vsc-image04.png](/setting-vsc-image04.png)
링크를 통해 들어간 홈페이지에서 download 항목 접속

![첨부파일/setting-vsc-image05.png](/setting-vsc-image05.png)
스크롤을 내린후 source forge 항목에 접속

![첨부파일/setting-vsc-image06.png](/setting-vsc-image06.png)
원하는 버전 다운로드 (안 될 가능성 높음)

##### 2. 개발자 Github를 통한 다운로드
다음은 개발자의 github를 통하여 다운로드 받는 법이다.
![첨부파일/setting-vsc-image07.png](/setting-vsc-image07.png)
...
## MinGW Path 설정
![첨부파일/setting-vsc-image08.png](/setting-vsc-image08.png)
![첨부파일/setting-vsc-image09.png](/setting-vsc-image09.png)
위치에 파일을 옮기면 된다.

다음은 환경변수를 설정해야 한다.
![첨부파일/setting-vsc-image10.png](/setting-vsc-image10.png)
win+R을 누르고 sysdm.cpl을 친다.

![첨부파일/setting-vsc-image11.png](/setting-vsc-image11.png)
해당 항목이 뜨면, 고급 항목을 누른다.

![첨부파일/setting-vsc-image12.png](/setting-vsc-image12.png)
환경 변수를 누른다.

![첨부파일/setting-vsc-image13.png](/setting-vsc-image13.png)
시스템 변수에서 변수명이 Path인 항목을 찾아 누른다.

![첨부파일/setting-vsc-image14.png](/setting-vsc-image14.png)
새로 만들기를 누른 후 C:\mingw64\bin 을 추가한다.

위의 설정이 모두 끝난 후 깔렸는지 확인하는 방법은
cmd(명령 프롬포트)에 g++ --version을 입력한다.
![첨부파일/setting-vsc-image15.png](/setting-vsc-image15.png)
...
![첨부파일/setting-vsc-image16.png](/setting-vsc-image16.png)

### 1. C/C++
![첨부파일/setting-vsc-image17.png](/setting-vsc-image17.png)
C++로 진행할 것이므로 C/C++, C/C++ Extension Pack을 설치한다.

### 2. Korean Language Pack for Visual Studio Code
![첨부파일/setting-vsc-image18.png](/setting-vsc-image18.png)
Korean Language Pack for Visual Studio Code는 한국어로 바꿔주는 확장인데, 설치하고 싶다면 설치하면 된다.

## VSCode C++ 빌드 및 디버깅 환경 설정

![첨부파일/setting-vsc-image19.png](/setting-vsc-image19.png)
좌측 첫 아이콘을 눌려 폴더를 만들거나 연다.

![첨부파일/setting-vsc-image20.png](/setting-vsc-image20.png)
1이 가르키는 아이콘을 눌려 파일을 생성하고 적당한 이름.cpp 파일을 생성한다.

![첨부파일/setting-vsc-image21.png](/setting-vsc-image21.png)
f1을 누르면 위의 검색창이 열리는데, C/C++:Edit Configurations (UI)를 누른다.

![첨부파일/setting-vsc-image22.png](/setting-vsc-image22.png)
...
다시 처음으로 돌아와
![첨부파일/setting-vsc-image23.png](/setting-vsc-image23.png)
오른쪽 위의 톱니바퀴를 누른뒤 C/C++: g++.exe 활성 파일 빌드 및 디버그을 누른다.

그 다음 task.json의 program과 args의 인자를 다음과 같이 바꾼다.

| ![첨부파일/setting-vsc-image24.png](/setting-vsc-image24.png) | ![첨부파일/setting-vsc-image25.png](/setting-vsc-image25.png) |
| ---------------- | ---------------- |
| ![첨부파일/setting-vsc-image26.png](/setting-vsc-image26.png) | ![첨부파일/setting-vsc-image27.png](/setting-vsc-image27.png) |
설정이 완료되었다면, F5를 누를시 컴파일이 진행된다.

만일 오류 발생시 다음의 설명을 참고하자.

호환성 항목을 들어가고,
![첨부파일/setting-vsc-image28.png](/setting-vsc-image28.png)

모든 사용자에 대한 설정 변경 항목을 누르고
![첨부파일/setting-vsc-image29.png](/setting-vsc-image29.png)

호환모드가 본인의 OS와 같은지 확인하라
![첨부파일/setting-vsc-image30.png](/setting-vsc-image30.png)
