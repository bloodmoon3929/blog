...
![첨부파일/tf-Pasted image 20240702202221.png](/tf-Pasted%20image%2020240702202221.png)
#### tanh
$$
tanh(z)=\frac{e^z-e^{-z}}{e^z+e^{-z}}
$$
입력이 $(-\infty , ~\infty)$에서 변할 때, 출력은 (-1,1)에서 변화를 가진다.
![첨부파일/tf-Pasted image 20240702212625.png](/tf-Pasted%20image%2020240702212625.png)
#### ReLU
$$
f(x)=max(0,x)
$$
입력이 $(-\infty , ~\infty)$에서 변할 때, 출력은 $(0,\infty)$에서 변화를 가진다.
![첨부파일/tf-Pasted image 20240702213552.png](/tf-Pasted%20image%2020240702213552.png)
### ELU와 LeakyReLU
...
![첨부파일/tf-Pasted image 20240702213625.png](/tf-Pasted%20image%2020240702213625.png)
#### LeakyReLU
$$
f(\alpha,x)=
\begin{cases}
...
![첨부파일/tf-Pasted image 20240702213719.png](/tf-Pasted%20image%2020240702213719.png)
## 예제 - 필기체 학습
이미 정답이 존재하는 지도 학습임
