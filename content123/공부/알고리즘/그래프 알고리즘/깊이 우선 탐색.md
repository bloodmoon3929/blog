---
{"dg-publish":true,"permalink":"/공부/알고리즘/그래프 알고리즘/깊이 우선 탐색/"}
---
...
DFS는 [[공부/알고리즘/그래프 알고리즘/너비 우선 탐색\|너비 우선 탐색]](BFS)과 다르게 [[공부/자료구조/queue\|queue]]가 아닌 [[공부/자료구조/stack\|stack]]을 사용한다.
