# Jira
![alt text](/src/site/img/user/%EC%B2%A8%EB%B6%80%ED%8C%8C%EC%9D%BC/Asset/JiraLogo.png)
...
## Jira의 기본 흐름
![alt text](/src/site/img/user/%EC%B2%A8%EB%B6%80%ED%8C%8C%EC%9D%BC/Asset/Jirabar.png)
Jira에 접속하여 상단에 네비게이션 바에서 우측 만들기 버튼을 눌려 프로젝트 생성

![alt text](/src/site/img/user/%EC%B2%A8%EB%B6%80%ED%8C%8C%EC%9D%BC/Asset/Jiraissu.png)
사용자는 새로운 작업을 Issue로 생성한다.

![alt text](/src/site/img/user/%EC%B2%A8%EB%B6%80%ED%8C%8C%EC%9D%BC/Asset/Jiraboard.png)
