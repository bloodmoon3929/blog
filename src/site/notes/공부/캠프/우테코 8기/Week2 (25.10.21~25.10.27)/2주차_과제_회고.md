...
![alt text](/src/site/img/user/%EC%B2%A8%EB%B6%80%ED%8C%8C%EC%9D%BC/2%EC%A3%BC%EC%B0%A8-%ED%9A%8C%EA%B3%A0%EC%9A%A9-jira-%ED%83%80%EC%9E%84%EB%9D%BC%EC%9D%B8-1.png)

만들어야 하는 큰 기능을 클래스로 구분하고, 그 클래스 안에 구현해야 되는 작은 단위의 기능들을 task로 잡아서 타임라인을 만들었습니다.

![alt text](/src/site/img/user/%EC%B2%A8%EB%B6%80%ED%8C%8C%EC%9D%BC/2%EC%A3%BC%EC%B0%A8-%ED%9A%8C%EA%B3%A0%EC%9A%A9-jira-%EB%AA%A9%EB%A1%9D-1.png)
타임 라인을 보면서 현재 완료된 기능은 무엇인지, 우선 순위가 어디가 높은지 확인하며 댓글을 통해 이슈를 남길 수도 있습니다.

![alt text](/src/site/img/user/%EC%B2%A8%EB%B6%80%ED%8C%8C%EC%9D%BC/2%EC%A3%BC%EC%B0%A8-%ED%9A%8C%EA%B3%A0%EC%9A%A9-jira-%EB%B3%B4%EB%93%9C-1.png)
